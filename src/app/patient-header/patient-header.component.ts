...
@Component({
  ...
  standalone: true,
  imports: [AllergyWarningComponent, GlobalSearchFieldComponent, MatIconButton, MatIcon, MatExpansionPanel, MatExpansionPanelTitle, MatExpansionPanelDescription, MatExpansionPanelHeader, MatFormField, MatLabel, MatInput, DatePipe, NgIf, MatTabGroup, MatTab, TableComponent],
