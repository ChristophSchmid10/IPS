  ...
  ngOnInit() {
    ...
    switch (this.dataType) {
      case Data.Medication:
        this.headerLabels = ['Medikament', 'Status', 'Dosierung', 'Einnahme seit', 'Einnahme bis'];
      ...
      case Data.Diagnosis:
        ...
        break;
      case Data.LabValue:
        this.headerLabels = ['Laborwert', 'Ergebenis', 'Gemessen am', 'Gemessen von'];
      ...
      case Data.Procedure:
        ...
        this.procedureServices.getProcedures().subscribe((data: Diagnosis[]) => {
          this.dataToShow = data;
        });
        break;
    }
